...
static struct FileData read_file(const char* test_file) {
    ...
    */
	...
	result.elems = static_cast<int*>(calloc(result.num_elems, sizeof(int)));
 ...
 */
static void assert_sets_equal(const int* data1, size_t size1, const int* data2, size_t size2) {
